...
% Input path:
input_main_path = sprintf('%s','./../data/Krupka/EHL_02_mainprocess/Output');

% Output path:
output_main_path = sprintf('%s','./../data/Krupka/EHL_03_mainprocess/Output');
% Save results:
