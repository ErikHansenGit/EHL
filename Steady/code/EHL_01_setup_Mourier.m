...
% Mourier, L., Mazuyer, D., Lubrecht, A. A., & Donnet, C. (2006). 
% Transient increase of film thickness in micro-textured EHL contacts. 
% Tribology International, 39(12), 1745-1756.
%
...
fld.mu_0        = 0.25;                                                     % [Pas]     lubricant dynamic viscosity at ambient pressure
...
%% Operating condition:
opc.W           = 15;                                                       % [N] Normal load force in negative x3-direction
opc.u_low       = 0;                                                        % [m/s] velocity of lower body in x1-direction
opc.u_up        = [2*0.09];                                                 % [m/s] velocity of upper body in x1-direction
...
x1_Wb           = -409.5e-6;                                                % [m]   x1-coordinate of cell at the West boundary
x1_Eb           = 409.5e-6;                                                 % [m]   x1-coordinate of cell at the East boundary
x2_Sb           = -409.5e-6;                                                % [m]   x2-coordinate of cell at the South boundary
x2_Nb           = 409.5e-6;                                                 % [m]   x2-coordinate of cell at the North boundary
...
alg.h_d_ma_nm2          = -1.0e-6;      % [m]   first initial guess of rigid body displacement in secant algorithm
alg.h_d_ma_nm1          = -0.5e-6;      % [m]   second initial guess of rigid body displacement in secant algorithm
alg.h_d_ma_max          = 0e-6;         % [m]   upper limit of rigid body displacement in secant algorithm
alg.h_d_ma_min          = -2.5e-6;      % [m]   lower limit of rigid body displacement in secant algorithm
