...
geo.Nx1         =  autorun.geo.Nx1(autorun.sim.it);                        % [-]   number of discretization points in the x1-direction
geo.Nx2         =  geo.Nx1;                                                % [-]   number of discretization points in the x2-direction
...
alg.FBNS.flag_res       = 6;            % [-]   flag, which residual definition is used 
...
% The least strict is  alg.FBNS.flag_res = 6; (just considers mean of p_hd update)
