...
%
% Heavily based on the work Erik Hansen on 18.05.2021 from the rest of the
...
% Output path:
output_main_path ='./../data/EHL_03_visualisation/Study_A/';
...
if flag_save_plots        
   plotname = char(compose('iterations'));
